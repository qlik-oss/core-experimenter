    ...
    GenericObject: {
      ...
      GetListObjectData: {
        In: [{ Name: 'qPath', DefaultValue: '' }, {
          Name: 'qPages',
          DefaultValue: [{
            qLeft: 0, qTop: 0, qWidth: 0, qHeight: 0,
          }],
        }],
        Out: [{ Name: 'qDataPages' }],
      },
      ...
      SelectListObjectContinuousRange: {
        In: [{ Name: 'qPath', DefaultValue: '' }, {
          Name: 'qRanges',
          DefaultValue: [{
            qMin: 0, qMax: 0, qMinInclEq: false, qMaxInclEq: false,
          }],
        }, { Name: 'qSoftLock', DefaultValue: false, Optional: true }],
        Out: [{ Name: 'qSuccess' }],
      },
      ...
      SetProperties: {
        In: [{
          ...
          DefaultValue: {
            qInfo: { qId: '', qType: '' },
            qDim: {
              qGrouping: 0, qFieldDefs: [''], qFieldLabels: [''], qLabelExpression: '',
            },
            qMetaDef: {},
          },
        }],
    ...
    Doc: {
      ...
      GetFileTables: {
        In: [{ Name: 'qConnectionId', DefaultValue: '' }, {
          ...
          DefaultValue: {
            ...
            qComment: '',
            qDelimiter: {
              qName: '', qScriptCode: '', qNumber: 0, qIsMultiple: false,
            },
            qCodePage: 0,
            qHeaderSize: 0,
            qRecordSize: 0,
      ...
      SearchSuggest: {
        In: [{
          Name: 'qOptions',
          DefaultValue: {
            qSearchFields: [''], qContext: 0, qCharEncoding: 0, qAttributes: [''],
          },
